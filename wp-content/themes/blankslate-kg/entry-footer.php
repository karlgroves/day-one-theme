...
<?php 
    printf(__('Also posted in %s', 'blankslate'), $catz); 
?>
</span>
...
<?php 
    if ( is_tag() && $tag_it = blankslate_tag_it(', ') ) : // 
?>
<span class="tag-links">
<?php 
    printf(__('Also tagged %s', 'blankslate'), $tag_it); 
?>
</span>
...
<?php 
    comments_popup_link(__('Leave a comment', 'blankslate'), __('1 Comment', 'blankslate'), __('% Comments', 'blankslate')); 
?>
</span>
